...
export class Tab2Page implements OnInit {
  ...
  generateQRCodeData(boleto: any): string {
    return `ID de usuario: ${boleto.userId}, ID de viaje: ${boleto.tripId}, Número de asientos: ${boleto.numberOfSeats}, Método de pago: ${boleto.paymentMethod}, Tipo de asiento: ${boleto.seatType}, Total: ${boleto.total}`;
}
